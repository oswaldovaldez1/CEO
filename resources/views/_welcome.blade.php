...
<script>
  ...
  gtag('config', 'UA-143895852-1');
    ...
    <body  onscroll="scrolln()" onload="scrolln()" onchange="scrolln()">
        ...
        @include('video')
        {{--
        @include('videofacebook')
        
        @include('videoyoutube')
        --}}
        <div class="tamastro" >
            @include('astro')
        </div>
...
<script>
 ...
 $('#basicSlider').multislider({
            ...
            continuous: false,
            interval: 5000, 
            hoverPause: false,	// pause slideshow on hover
            pauseAbove: false,   // pause above specified screen width
            pauseBelow: false    // pause below specified screen width           
        });
</script>
